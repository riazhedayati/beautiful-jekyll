...
The logistic regression had a misclassification rate of 15.6%, and the random forest had a misclassification rate of 15.2%. When comparing our misclassification rates, we can see that the random forest was the best performing model on this data.
